...
/**
 * Add handler to the handler resolver
 *
...
class HandlerPass implements CompilerPassInterface
{
    ...
    {
        $transformerCollectionDefinition = $container->getDefinition('api.handler.resolver');
        foreach ($container->findTaggedServiceIds('api_handler') as $serviceId => $tags) {
